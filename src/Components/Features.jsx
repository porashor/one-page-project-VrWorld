...
const Features = () => {
  return (
    <div className='container py-14 sm:min-h-[600px]'>
        <div>
          <h1 className='text-3xl font-semibold text-center py-10'>Why Choose Us </h1>
          {/* card sections */}
          <div className='grid grid-cols-1 sm:grid-cols-3 items-center gap-10'>
            {
              featuresData.map((item, index)=>(
                <div className='text-center group space-y-3 sm:space-y-6 sm:py-10 bg-dark hover:gradients hover:shadow-[0_0_40px_#007cfff0] text-white hover:text-black rounded-lg duration-300 px-10' key={index}>
